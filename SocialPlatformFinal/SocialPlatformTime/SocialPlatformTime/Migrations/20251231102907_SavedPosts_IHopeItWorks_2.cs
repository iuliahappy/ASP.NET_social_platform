...
{
    /// <inheritdoc />
    public partial class SavedPosts_IHopeItWorks_2 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreateDGroup = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupRoles", x => new { x.Id, x.ApplicationUserId, x.GroupId });
                    table.ForeignKey(
                        name: "FK_GroupRoles_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SavedPosts", x => new { x.Id, x.ApplicationUserId, x.PostId });
                    table.ForeignKey(
                        name: "FK_SavedPosts_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Messages", x => new { x.Id, x.ApplicationUserId, x.ConversationId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserConversations_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupRoles_ApplicationUserId",
                table: "GroupRoles",
                column: "ApplicationUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SavedPosts_ApplicationUserId",
                table: "SavedPosts",
                column: "ApplicationUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserConversations_ApplicationUserId",
